<template>
    <div class="enterprise-container text-left">
        <div class="mg-b30">
        ...
        <div class="enterprise-content ">
            <div class="enterprise-content-left  text-left">
                ...
                <el-tree ref="companyTree" :class="{companyTable: isone}" :data="companyList" node-key="factoryid" :default-expanded-keys="CompanyExpandedArray" @node-expand="nodeExpand" :expand-on-click-node="false" :highlight-current="true" @node-click="NodeClick" :props="CompanyProps" :render-content="renderContent">
                </el-tree>
            </div>
...
export default {
    ...
    methods: {
        ...
        amendCompany(store, data, event) {
            ...
            event = arguments.callee.caller.arguments[0] || event
            stopEvent(event)
            // this.$util.stopBubble(event)
        },
        // 删除企业
