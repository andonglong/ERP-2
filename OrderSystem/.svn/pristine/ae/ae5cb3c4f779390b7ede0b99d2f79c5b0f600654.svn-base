  ...
  data() {
    return {
      ...
      IndustryDataRules: {
        ...
        mainproduct: [{ required: true, message: '请输入', trigger: 'blur' }]
      },
      BusinessData: {}, // 商业信息
      BusinessOptions: {},
